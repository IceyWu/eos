...
const mediaList = ref([
  {
    ...
    style: "background: linear-gradient(135deg, rgba(255,107,107,0.9) 0%, rgba(254,202,87,0.9) 100%), url('https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800') center/cover; background-blend-mode: overlay;"
  },
  {
    type: "video",
    label: "精彩视频",
  ...
  },
  {
    ...
    label: "城市夜景",
    description: "霓虹灯下的都市",
    style: "background: linear-gradient(135deg, rgba(99,102,241,0.85) 0%, rgba(168,85,247,0.85) 100%), url('https://images.unsplash.com/photo-1514565131-fce0801e5785?w=800') center/cover; background-blend-mode: overlay;"
  },
  {
    type: "video",
    label: "短片欣赏",
  ...
  },
  {
    ...
    label: "自然风光",
    description: "山川湖泊之美",
    style: "background: linear-gradient(135deg, rgba(34,197,94,0.85) 0%, rgba(59,130,246,0.85) 100%), url('https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800') center/cover; background-blend-mode: overlay;"
  }
]);
