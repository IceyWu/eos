    ...
    <main className="eos-home">
      ...
      <section className="eos-home__showcase">
        ...
        <div className="eos-home__cards">
          <Link className="eos-home__card eos-home__card--large" to="/components/button">
